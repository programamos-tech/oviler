...
export const STORE_TECH_COPY = {
  nav: {
    ...
    descriptions: {
      ...
      actividades: "Qué pasó en la tienda: ventas, clientes y el equipo",
  ...
  workspace: {
    ...
    actividades: "Actividad de la tienda",
    roles: "Equipo de tienda",
  ...
  actividades: {
    title: "Actividad de la tienda",
    subtitle: "Aquí ves qué pasó: ventas, clientes, stock, garantías y el equipo.",
