        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-[13px] font-medium text-slate-500 dark:text-slate-400">
              Cada sede tendrá sus propios números de ingreso, inventario y configuración.
            </p>
          </div>
          <Link
            href="/sucursales"
          ...
          <div className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            ...
            <div className="mt-3 space-y-3">
              <div>
                ...
                <input placeholder="Ej. Sede Norte" className={inputClass} />
              </div>
              <div>
              ...
              <div>
                ...
                <input placeholder="Ej. Cra 15 # 80-10" className={inputClass} />
              </div>
              <div>
                <label className={labelClass}>Teléfono</label>
                <input placeholder="Ej. 601 765 4321" className={inputClass} />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            ...
            <p className="mt-3 text-[13px] text-slate-600 dark:text-slate-400">
              La nueva sede tendrá su propia numeración de ingresos, inventario independiente y configuración propia.
            </p>
