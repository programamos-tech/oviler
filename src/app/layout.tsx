...
title: "NOU Iglesias | Gestión para iglesias",
    description:
      "Sistema de gestión para iglesias. Ingresos, miembros, inventario y reportes. Implementación, capacitación y soporte.",
};
