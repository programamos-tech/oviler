...
export default function EditEmployeePage() {
  ...
  const [nombre, setNombre] = useState("María López");
  const [username, setUsername] = useState("mlopez");
  const [email, setEmail] = useState("maria@tienda.com");
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-[13px] font-medium text-slate-500 dark:text-slate-400">
              Actualiza datos, foto o usuario del empleado.
            </p>
          </div>
          <Link
            href="/roles"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[12px] text-slate-500 dark:text-slate-400">
                      Nueva foto se subirá al bucket al guardar.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            <div className="space-y-3">
              <div className="text-[13px] font-medium text-slate-600 dark:text-slate-400">
                ...
                <p className="mt-1">
                  Los cambios se guardarán y, si subiste una nueva foto, se actualizará en el bucket.
                </p>
              </div>
              <button
                type="button"
