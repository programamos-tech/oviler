...
const sidebarIconClass = "h-[22px] w-[22px] shrink-0";

function SidebarSvg({ children, d }: { children?: React.ReactNode; d?: string }) {
  if (d) {
    return (
      <svg className={sidebarIconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={sidebarStroke} d={d} />
      </svg>
    );
  }
  return (
...
export type SidebarNavModule = "COMERCIAL" | "OPERACIÓN" | "CONFIGURACIÓN";
...
export const sidebarNavEntries: SidebarNavEntry[] = [
  {
    ...
    navModule: "COMERCIAL",
    icon: (
      <SidebarSvg d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
    ),
  },
  {
    label: "Ventas",
    ...
    navModule: "COMERCIAL",
    icon: (
      <SidebarSvg d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
    ),
  },
  {
    label: "Clientes",
    ...
    navModule: "COMERCIAL",
    icon: (
      <SidebarSvg d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
    ),
  },
  {
    label: "Garantías",
    ...
    navModule: "COMERCIAL",
    icon: (
      <SidebarSvg d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
    ),
  },
  {
    label: "Créditos",
    ...
    navModule: "COMERCIAL",
    icon: (
      <SidebarSvg d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
    ),
  },
  ...(SHOW_COMERCIAL_CATALOGO_MODULE
    ? [
        {
          label: "Catálogo",
          href: "/catalogo",
          navModule: "COMERCIAL" as const,
          icon: (
            <span className="sidebar-nav-icon [&_svg]:h-[22px] [&_svg]:w-[22px] [&_svg]:stroke-[1.5]">
              <IconCatalogNav />
            </span>
          ),
        },
  ...
  },
  {
    ...
    navModule: "OPERACIÓN",
    icon: (
      <SidebarSvg d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
    ),
  },
  {
    label: "Actividades",
    ...
    navModule: "OPERACIÓN",
    icon: (
      <SidebarSvg d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
    ),
  },
  {
    label: "Egresos",
    ...
    ? [
        {
          ...
          icon: (
            <SidebarSvg d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          ),
        },
        {
          label: "Configuración",
          ...
          navModule: "CONFIGURACIÓN" as const,
          icon: (
            <SidebarSvg d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
          ),
        },
      ]
    : []),
