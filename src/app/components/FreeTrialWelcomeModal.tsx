    ...
    >
      ...
      >
        <div className="flex items-start gap-3">
          <div
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-sky-500/15 text-xl dark:bg-sky-500/20"
            aria-hidden
          >
            ⏱
          </div>
          <div className="min-w-0 flex-1">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-emerald-700/25 bg-emerald-500/[0.07] px-4 text-[14px] font-medium text-emerald-900 transition-colors hover:border-emerald-600/35 hover:bg-emerald-500/[0.12] dark:border-emerald-400/20 dark:bg-emerald-950/50 dark:text-emerald-100 dark:hover:border-emerald-400/30 dark:hover:bg-emerald-900/40"
            >
